$(document).ready(function () {
  ...
  function fetchTrxData() {
    ...
    const url = `http://localhost/DreamNest/backend/api/v1/trx_list_admin/abh1522agwe522255hba514125/${accessToken}/${email}`;
  ...
  $(document).on("click", ".make-sattlement", function (e) {
    ...
    const url = `http://localhost/DreamNest/backend/api/v1/sattlement_user_admin/abh1522agwe522255hba514125/${accessToken}/${email}/${slValue}`;
